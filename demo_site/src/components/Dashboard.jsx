                    ...
                    >
                      ...
                      <div className="w-16 h-16 rounded-lg bg-gray-50 border border-gray-100 flex items-center justify-center flex-shrink-0 overflow-hidden">
                        {scan.status === 'processing' ? (
                          ...
                          <button
                            type="button"
                            onClick={() => setLightbox(scan)}
                            className="w-full h-full group/thumb relative cursor-zoom-in"
                            title="View full graded sheet"
                          >
                            ...
                            <span className="absolute inset-0 bg-black/0 group-hover/thumb:bg-black/30 flex items-center justify-center transition-colors">
                              <ImageIcon className="w-5 h-5 text-white opacity-0 group-hover/thumb:opacity-100 transition-opacity" />
                            </span>
                          </button>
                        ) : (
                        ...
                        {scan.status === 'success' && hasImage && (
                          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                            <button
                              ...
                              className="p-1.5 text-gray-300 hover:text-[#3B0042] hover:bg-purple-50 rounded-md transition-colors"
                              title="Download graded sheet"
                            >
                              <Download className="w-4 h-4" />
                            </button>
                            <button
              ...
              <div className="p-4 border-b border-gray-100 flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#3B0042] text-white text-xs font-bold rounded-lg hover:bg-[#4d0055] transition-colors"
                  >
